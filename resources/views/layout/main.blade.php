    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/contato">Realizações</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Lucas Aplication</a>
                </li>
            </ul>
            </div>
        </div>
        ...
        <footer class="text-center text-lg-start" style="background-color: #212529;">
            <div class="container d-flex justify-content-center py-5">
              <a href="https://www.facebook.com/people/Lucas-Ferreira/100011522139400/" target="_blank" rel="noreferrer noopener">
              ...
              <a href="https://www.youtube.com/channel/UCok5XK_YSdaesDT6N6PCK0w" target="_blank" rel="noreferrer noopener">
              <button type="button" class="btn btn-light btn-lg btn-floating mx-2" style="background-color: #23861a;">
            ...
            <div class="text-center text-white p-3 fixed-botom" style="background-color: rgba(0, 0, 0, 0.2);">
                <p><a class="text-white" href="https://github.com/lucasferne" target="_blank" rel="noreferrer noopener">Lucas Ferreira</a> &copy; 2021 </p> 
            </div>
            <!-- Copyright -->
          </footer>
